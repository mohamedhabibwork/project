...
if ($_SERVER['REQUEST_METHOD']==="POST") {
    ...
    if ($password !==$password_2) {
        $errors['password_2']=" password not match ";
    }
    elseif(emailExists($email)){
        $errors['email']=" email already exists ";
    }
    elseif (register($email,$password)) {
        // exit(BASE_URL.'index.php');
        redirect('pages/login.php');
    }else{
        $errors['email']=" somting is wrong ";
    }
...
.txtbox ::placeholder{ color: rgba(8, 0, 0, 0.767); }
        ...
        <section class="center-section">
            ...
            <div class="animate-logo"> <img src="<?= BASE_URL.'assets/'; ?>img/xz.gif"></div>
             <form action="./regester.php" method="POST" class="regstor">
                ...
                <!-- <input type="text" name="text2"placeholder="First Name" >  -->
                <!-- <input type="text" name="text2" placeholder="Last Name"><br> -->
                ...
                <!-- <input type="text" name="text2" placeholder="Phone Number" ><br> -->
               ...
               <!-- </label><label> <i class="r">male</i>
                <input type="radio" name="Gender" value="male">
                

               <label>  </div> <i class="r">female</i>
