...
if (!$_SESSION['login']) { redirect('pages/index.php');}
...
section{text-align:center;width:1000px;min-height:400px;margin:30px auto;padding:1px 15px 15px;border-radius:5px}
.section input,.section select{border:0;padding:5px;width:50%;margin:5px;font-size:14px;border-radius:10px}
.section textarea{width:50%;border:0;resize:none}
.section button{padding:5px;border:0;font-size:20px}
.section button:hover{background-color:#9b036b;color:#fff}
